...
if [[ ! -d "sites/dashboard/public_html/phpmyadmin" ]]; then
    ...
    wget https://files.phpmyadmin.net/phpMyAdmin/5.0.1/phpMyAdmin-5.0.1-all-languages.zip -O "sites/dashboard/public_html/phpmyadmin/phpmyadmin.zip"
    unzip "sites/dashboard/public_html/phpmyadmin/phpmyadmin.zip"
    mv phpMyAdmin-5.0.1-all-languages/* "sites/dashboard/public_html/phpmyadmin"
